...
| 測試批次 | Outlook 測試事件 | SharePoint 測試紀錄 | 負責人 |
|---|---|---|---|
| FT-113（v0.3.2） | TEST-FT113-A/B、A2/B2、A3/B3 | ID 13、14、16、17 | 待清理，詳見 `release-notes/v0.3.2.md` |
| SG-T09（v0.3.3） | TEST-SGT09-A（2026/8/4 14:00-14:30，ATA-9627） | ID 19、ID 21 | 專案負責人自行清理 |
...
功能測試（FT-101～FT-113）與系統防呆測試（SG-T01～SG-T10）核心項目均已通過，FT-114 已由替代技術方案（HTTP 直連 Graph）解決並驗證，不影響正式流程運作。剩餘事項為已明確記錄之非阻擋性已知限制，以及本輪測試資料之清理作業。待測試資料清理完成後，系統即符合正式上線條件。
