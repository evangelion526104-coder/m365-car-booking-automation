...
| 目前版本 | `v0.3.5` |
| 目前開發階段 | 專案仍為**測試階段，尚未正式啟用**。2026-08-06 員工回報收到重複借車通知卡片，診斷確認為系統性 Bug#1（詳見 CHANGELOG v0.3.4 追加說明、`docs/incident-handling-guide.md` 第三節），修正邏輯已完成；同日另排查循環預借（同一人連續多日借用同一台車）每日重複發卡問題，原規劃「自動延用」邏輯並完成實作，惟因借用人共乘人數需逐日填寫，2026-08-07 專案負責人確認不採用，已將相關流程動作移除，回復逐日發送借用人確認卡片的原設計。「公務車借用前Teams通知與回覆」與「公務車行事曆同步至SharePoint」兩流程目前全部關閉止血，待專案負責人確認 Bug#1 修正結果後才會重新開啟；另 FT-113、SG-T09 測試資料清理事項維持原狀 |
| 專案完成度 | 99%（Bug#1 修正邏輯已完成，循環預借逐日發卡設計維持不變，尚待專案負責人審閱後重新開啟才可正式上線） |
| 最新更新日期 | 2026-08-07 |
