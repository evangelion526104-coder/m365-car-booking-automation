...
| 目前版本 | `v0.3.7` |
| 目前開發階段 | 專案仍為**測試階段，尚未正式啟用**。2026-08-08～2026-08-27 逐項複查並拍板「差異確認決策清單」（`docs/company-account-and-booking-rules-change-decisions.md`）#128～#134：其中共乘人數欄位／Card 優先順序訊息／換車邏輯／借用人判斷 4 項複查後確認既有程式碼或架構已覆蓋，非待實作項目；Graph 查詢時間窗已調整為 -24hr～+14 天並驗證生效；兩流程失敗告警同步流程已確認、Teams 流程因 Power Automate 連線異常待補查。複查過程中意外發現『公務車行事曆同步至SharePoint』流程已停用 19 天（8/8～8/27），已於 2026-08-27 重新開啟並手動執行一次補回同步資料。Teams 通知流程仍維持關閉，待 SG-T07 重新驗證（原結果已撤回）與 Bug#1 端到端測試安排後再決定是否開啟 |
| 專案完成度 | 99%（#128～#134 除 #134 Teams 流程告警待補查外皆已結案；#135 Power Apps 即時同步、#136 循環預約完整實作、#137 SG-T07 重新驗證尚待進行） |
| 最新更新日期 | 2026-08-27 |
